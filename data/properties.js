  ...
  var PROPERTIES = [
    {
      ...
      address: '白金台四丁目7番12号',
      access: [
        { line: '東京メトロ南北・都営三田線', station: '白金台', walk: 1 },
        { line: 'JR山手線', station: '目黒', walk: 13 }
      ],
      rent: 1000000, managementFee: 0, deposit: 2, keyMoney: 2,
      contractTerm: '定期借家・10年',
      areaTsubo: 12.7,
      floor: '1',
      floorsTotal: 0,
      builtYear: null,
      structure: '鉄筋コンクリート造陸屋根',
      features: ['1階路面', '居抜き'],
      usage: ['カフェ', '飲食店', 'バー', '物販', 'サービス', 'クリニック', 'スクール', 'ショールーム', 'ギャラリー', '事務所', '店舗'],
      availableFrom: '即時',
      updatedAt: '2026-08-06',
      description: '白金台駅徒歩1分、路面1階・専有面積：41.99㎡（12.7坪）重飲食・何商可能（24時間営業可能）旧カフェ居抜き（厨房設備あり）、ガス（10号引き込み予定）、2026年5月に外観等の改修工事済み\n■改装協力金1,000,000円\n■重飲食・何商可能（24時間営業可能）\n■フリーレント１ヶ月\n■内覧可能（立ち合い）\n■看板設置相談可能\n■引き渡し：即日可能\n■保証会社加入要(USENTRUST)　賃料の1ヶ月分\n※保証会社の審査次第で敷金等の条件がある場合あり\n※2年以内の解約時は短期解約違約金として賃料2ヶ月分要'
    }
  ];
  /* === PROPERTIES:END === */
