...
10. [広告のルール（宅建業法・表示規約）](#10-広告のルール宅建業法表示規約)
11. [用語集](#11-用語集)
...
```mermaid
flowchart LR
    A["🖥 管理画面（microCMS）<br/>物件情報・写真"] -->|公開ボタン| B["⚙️ 自動反映<br/>1〜2分"]
...
**まず1〜2分待ってください。** 反映には少し時間がかかります。

5分待っても出ない場合は、入力に問題があって反映が止まっています。
